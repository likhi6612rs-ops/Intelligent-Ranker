 ...
 */
export const analyzeResumes = async (analyzeInput: AnalyzeInput, options?: RequestInit): Promise<RankingResult> => {

  return customFetch<RankingResult>(getAnalyzeResumesUrl(),
  {
    ...options,
    method: 'POST',
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof analyzeResumes>>, {data: BodyType<AnalyzeInput>}> = (props) => {
          const {data} = props ?? {};
